                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '6px' }}>
                      <button 
                        ...
                        style={{ background: 'rgba(94, 92, 230, 0.2)', color: 'var(--primary-color)', border: 'none', padding: '6px 10px', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '4px' }}
                      >
                        + Цену
                      </button>
                      <button 
                        onClick={() => handleDeleteProduct(cat.originalIndex, item.originalIndex)}
                        style={{ background: 'rgba(255, 69, 58, 0.1)', color: '#FF453A', border: 'none', padding: '6px', borderRadius: '6px', cursor: 'pointer' }}
                        title="Удалить товар"
                      >
                      ...
                      <div key={sIdx} style={{ 
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '4px' }}>
                          ...
                          <button 
                            ...
                            style={{ background: 'transparent', color: '#FF453A', border: 'none', padding: '4px', cursor: 'pointer', opacity: 0.8 }}
                          >
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="14" height="14">
                              <path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
                            </svg>
